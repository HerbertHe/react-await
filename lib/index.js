      ...
      if (children instanceof Array) {
        ...
        for (var i = 0; i < children.length; i++) {
          ...
          if (!!((_tmp$type = tmp.type) !== null && _tmp$type !== void 0 && _tmp$type.name) && ((_tmp$type2 = tmp.type) === null || _tmp$type2 === void 0 ? void 0 : _tmp$type2.name) === "Then") {
            ...
            _resolveChild = [/*#__PURE__*/React.cloneElement(tmp, _objectSpread$2({}, props))];
      ...
      if (children instanceof Array) {
        ...
        for (var i = 0; i < children.length; i++) {
          ...
          if (!!((_tmp$type3 = tmp.type) !== null && _tmp$type3 !== void 0 && _tmp$type3.name) && ((_tmp$type4 = tmp.type) === null || _tmp$type4 === void 0 ? void 0 : _tmp$type4.name) === "Catch") {
            ...
            _rejectChild = [/*#__PURE__*/React.cloneElement(tmp, _objectSpread$2({}, props))];
...
var Catch = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Catch, [{
    ...
    value: function componentDidMount() {
      var _this$props = this.props,
          awaiterror = _this$props.awaiterror,
          children = _this$props.children;
      ...
      if (children instanceof Array) {
        ...
        for (var i = 0; i < children.length; i++) {
          ...
          if (!!tmp.type) {
            ...
            var child = /*#__PURE__*/React.cloneElement(tmp, _objectSpread$1({}, props));
      ...
      if (_typeof(children) === "object") {
        ...
        var _child = /*#__PURE__*/React.cloneElement(_tmp, _objectSpread$1({}, _props));
    ...
    key: "render",
    value: function render() {
      return /*#__PURE__*/React.createElement(Fragment, null, this.state.children);
    }
  }]);
...
var Then = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(Then, [{
    ...
    value: function componentDidMount() {
      var _this$props = this.props,
          awaitvalue = _this$props.awaitvalue,
          children = _this$props.children;
      ...
      if (children instanceof Array) {
        ...
        for (var i = 0; i < children.length; i++) {
          ...
          if (!!tmp.type) {
            ...
            var child = /*#__PURE__*/React.cloneElement(tmp, _objectSpread({}, props));
      ...
      if (_typeof(children) === "object") {
        ...
        var _child = /*#__PURE__*/React.cloneElement(_tmp, _objectSpread({}, _props));
